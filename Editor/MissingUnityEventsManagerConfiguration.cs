...
namespace Assets.MissingUnityEvents.Editor
{
    ...
    public class EventConfiguration
    {
        ...
        public EventConfiguration(string objectType, string propertyName)
        {
        ...
        {
            return new EventConfiguration("<Type>", "<Property Name>");
        }
    }
    ...
    public class MissingUnityEventsManagerConfiguration : EditorWindowPersistableConfiguration<MissingUnityEventsManagerConfiguration>
    {
        ...
        protected override void InitEmpty()
        {
            ...
            {
                new EventConfiguration(typeof(Transform).Name, nameof(Transform.position)),
                new EventConfiguration(typeof(Transform).Name, nameof(Transform.localScale)),
                new EventConfiguration(typeof(Transform).Name, nameof(Transform.rotation)),
            };
        }
